...
# Config
PROJECT_ID = os.environ.get('PROJECT_ID')  # Es. nimble-theme-279316
BUCKET_NAME = os.environ.get('BUCKET_NAME')
DATASET_ID = "champions_league"  # solo dataset, senza project
TABLE_ID = "raw_cl__matches"     # solo table, senza project
...
def load_cl_data_current(cloud_event):
